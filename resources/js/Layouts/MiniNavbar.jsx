...
export default function MiniNavbar() {
  ...
  <div className="flex justify-between items-center text-[10px] leading-none">
    <div className="inline-flex items-center gap-x-1 px-2 text-[11px] text-white leading-none"> 
  ...
  <span><a
    href="mailto:ptsp@mpukuturan.ac.id"
   
  >
    ptsp@mpukuturan.ac.id
  </a></span>
</div>


        <ul className="menu menu-horizontal px-1 text-xs">
          <li><a href="https://www.mpukuturan.ac.id" className="hover:text-gray-300 leading-none"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-4">
