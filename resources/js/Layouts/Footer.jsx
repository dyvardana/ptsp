  ...
  return (
    ...
    <footer className=" py-10 px-6 mt-10">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
        ...
        {/* Kolom 1 */}
        <div>
          <h3 className="text-lg font-semibold text-blue-700 mb-2">Tentang</h3>
        ...
        <div>
          ...
          <p className="text-gray-600 text-sm">Jl. Pulau Menjangan No 27 Banyuning, Singaraja</p>
          <p className="text-gray-600 text-sm">Email: ptsp@mpukuturan.ac.id</p>
          <p className="text-gray-600 text-sm">Telepon: (0362) 21289</p>
        </div>

        {/* Kolom 3 */}
        <div>
          <h3 className="text-lg font-semibold text-blue-700 mb-2">Tautan Cepat</h3>
