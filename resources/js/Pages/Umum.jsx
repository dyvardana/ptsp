...
export default function Umum() {
    ...
    const layanan = {
        ...
        "Dosen/Pegawai": {
            Penelitian: ["Proposal penelitian", "Surat pengantar dari lembaga"],
            "Pengabdian Masyarakat": [
                "Surat tugas resmi",
                "Identitas penyelenggara",
            ],
            TIK: ["Deskripsi masalah teknis", "Identitas pemohon"],
        },
        "Masyarakat Umum": {
            Permohonan: [
            ...
            Keuangan: ["Surat permohonan resmi", "Tujuan permintaan data"],
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <input
                                            ...
                                            onChange={handleChange}
                                            className="input input-bordered w-full"
                                            placeholder="No. HP (contoh : 087861123321)"
                                            required
                                        />
                                        <input
                                            type="email"
                                ...
                                <div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        >
                                            ...
                                            <option value="Mendapatkan salinan">
                                                Mendapatkan Salinan
                                            </option>
                                        </select>
                                        <select
